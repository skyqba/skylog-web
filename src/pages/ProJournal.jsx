      ...
      <div style={{ position:'relative', zIndex:1, maxWidth:780, margin:'0 auto' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(280px, 1fr))', gap:'1rem', marginBottom:'1.25rem' }}>
          <GlassCard style={{ padding:'1.5rem' }}>
            ...
            {monthData.length > 1 && <div style={{ marginTop:'1rem', height:50 }}><ResponsiveContainer width="100%" height="100%"><LineChart data={monthData}><Line type="monotone" dataKey="count" stroke="#8B5CF6" strokeWidth={2} dot={false} /><Tooltip contentStyle={{ background:'rgba(15,23,42,0.95)', border:'1px solid rgba(139,92,246,0.3)', borderRadius:10, fontSize:'0.78rem', color:'#fff', fontFamily:'var(--font)' }} itemStyle={{ color:'#A78BFA' }} labelFormatter={(l) => 'Miesiąc: ' + l} formatter={(v) => [v + ' skoków', '']}ów\`, '']} cursor={{ stroke:'rgba(139,92,246,0.3)', strokeWidth:1 }} /></LineChart></ResponsiveContainer></div>}
          </GlassCard>
